...
class DuasData {
  ...
  static const List<DuaModel> duas = [
    ...
    DuaModel(
      ...
      transliteration:
          'AṣbaḥnĀ wa aṣbaḥa-l-mulku lillĀhi, wa-l-ḥamdu lillĀhi, lĀ ilĀha illĀ-llĀhu waḥdahu lĀ sharīka lahu, lahu-l-mulku wa lahu-l-ḥamdu wa huwa ʿalĀ kulli shay\'in qadīr',
      translation:
    ...
    DuaModel(
      ...
      transliteration:
          'Aʿūdhu billĀhi mina-sh-shayṭĀni-r-rajīm, AllĀhu lĀ ilĀha illĀ huwa-l-ḥayyu-l-qayyūm',
      translation:
    ...
    DuaModel(
      ...
      transliteration:
          'AmsaynĀ wa amsĀ-l-mulku lillĀhi, wa-l-ḥamdu lillĀhi, lĀ ilĀha illĀ-llĀhu waḥdahu lĀ sharīka lahu',
      translation:
    ...
    DuaModel(
      ...
      transliteration:
          'AllĀhumma bĀʿid baynī wa bayna khaṭĀyĀya kamĀ bĀʿadta bayna-l-mashriqi wa-l-maghrib',
      translation:
    ...
    DuaModel(
      ...
      transliteration:
          'Astaghfiru-llĀh (3x), AllĀhumma anta-s-salĀmu wa minka-s-salĀm',
      translation:
    ...
    DuaModel(
      ...
      transliteration:
          'Bismi-llĀhi-lladhī lĀ yaḍurru maʿa-smihi shay\'un fī-l-arḍi wa lĀ fī-s-samĀ\'i wa huwa-s-samīʿu-l-ʿalīm',
      translation:
    ...
    DuaModel(
      ...
      transliteration:
          'AllĀhumma innā nas\'aluka fī safarinĀ hĀdha-l-birra wa-t-taqwĀ wa mina-l-ʿamali mĀ tarḍĀ',
      translation:
